...
/**
 * xvolutionscmsDevDebugProjectContainer
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class xvolutionscmsDevDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'xvolutions_admin.misc' => 'getXvolutionsAdmin_MiscService',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'XvolutionsAdminBundle', '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/Resources/XvolutionsAdminBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'XvolutionsAdminBundle', '/Users/pedroresende/Sites/AdminBundle/src/Xvolutions/AdminBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../bin/yuicompressor.jar', '/usr/bin/java');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../bin/yuicompressor.jar', '/usr/bin/java');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_172e85c0185bfbb5787bfa47316c20039bf19c6251e4ed3a061cb1ba392aa639');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_172e85c0185bfbb5787bfa47316c20039bf19c6251e4ed3a061cb1ba392aa639');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_172e85c0185bfbb5787bfa47316c20039bf19c6251e4ed3a061cb1ba392aa639');
        ...
        $e->setProxyDir('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'xvolutionscmsDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'xvolutionscmsDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/pedroresende/Sites/AdminBundle/xvolutionscms');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/pedroresende/Sites/AdminBundle/xvolutionscms', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/pedroresende/Sites/AdminBundle/xvolutionscms', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/Resources/views');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => '/Users/pedroresende/Sites/AdminBundle/src/Xvolutions/AdminBundle/Resources/config/validation.yml'));
    ...
    /**
     * Gets the 'xvolutions_admin.misc' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getXvolutionsAdmin_MiscService()
    {
        return $this->services['xvolutions_admin.misc'] = new \Xvolutions\AdminBundle\Helpers\Misc('fetchGravatar');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'xvolutionscms',
            'kernel.cache_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev',
            'kernel.logs_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/logs',
            ...
            'kernel.container_class' => 'xvolutionscmsDevDebugProjectContainer',
            ...
            'boundaries' => 2,
            'around' => 2,
            'uploaded_files' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../web/files',
            ...
            'debug.container.dump' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/xvolutionscmsDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/profiler',
            ...
            'router.options.matcher.cache_class' => 'xvolutionscmsDevUrlMatcher',
            'router.options.generator.cache_class' => 'xvolutionscmsDevUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/assetic/routing.yml',
            'router.cache_class_prefix' => 'xvolutionscmsDev',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../web',
            'assetic.write_to' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../web',
            ...
            'assetic.filter.yui_css.jar' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../bin/yuicompressor.jar',
            ...
            'assetic.filter.yui_js.jar' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/../bin/yuicompressor.jar',
            ...
            'doctrine.orm.proxy_dir' => '/Users/pedroresende/Sites/AdminBundle/xvolutionscms/cache/dev/doctrine/orm/Proxies',
